...
def run_benchmark():
    """Execute the graph build benchmark."""
    print("=" * 60)
    ...
    print("\n[Setup] Clearing existing cache for benchmark region...")
    # Simply build without cache to measure fresh build time
    # (save_to_cache=False avoids polluting production cache)

    print("[Benchmark] Starting full graph build...")
