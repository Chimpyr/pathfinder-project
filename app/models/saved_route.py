...
SavedRoute Model
================
Stores user-saved routes in parametrised form (start/end coords + weights).
Optionally stores exact polyline geometry for deterministic recall.

Design Decision (see implementation_plan.md):
...
class SavedRoute(db.Model):
    ...
    name = db.Column(db.String(100), nullable=False, default='Untitled Route')
    ...
    def __repr__(self) -> str:
        ...
        return f'<SavedRoute "{self.name}" ({route_type})>'
